    ...
    public function woolentor_woocommerce_page_template( $template ){
        ...
        if ( class_exists( 'WooCommerce' ) ) {
            if( is_cart() ){
                ...
                $wl_checkout_page_id = !empty( is_wc_endpoint_url('order-received') ) ? woolentor_get_option_pro( 'productthankyoupage', 'woolentor_woo_template_tabs', '0' ) : woolentor_get_option_pro( 'productcheckoutpage', 'woolentor_woo_template_tabs', '0' );
