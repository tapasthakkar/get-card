(function ($) {
    ...
    var PremiumNavMenuHandler = function ($scope, $) {
        ...
        //TODO: check when do we add `menu-item-has-children`.
        // $scope.find('.premium-nav-menu-item.menu-item-has-children').on('mouseenter.PaItemHover', function() {
        $scope.find('.premium-nav-menu-item').on('mouseenter.PaItemHover', function (e) {

            e.stopPropagation();

            clearTimeout(hoverTimeout);
            $('.premium-item-hovered').removeClass('premium-item-hovered');
