...
if ( ! class_exists( 'Mega_Menu_Locations' ) ) :
	...
	class Mega_Menu_Locations {
		...
		public function add_menu_location() {
			...
			$title = 'WordPress Max Mega Menu Location ' . $next_id;
					...
					<tr>
						<td class='mega-name'>
							...
							<div class='mega-description'>
								...
								<p><?php esc_html_e( 'Use these options to enable WordPress Max Mega Menu and define the behaviour of each menu location.', 'megamenu' ); ?></p>
							</div>
						</td>
						<td class='mega-value mega-vartical-align-top'>
							...
							if ( ! count( $enabled_locations + $disabled_locations ) ) {
								echo '<p>';
								esc_html_e( 'Your theme does not natively support menus, but you can add a new menu location using WordPress Max Mega Menu and display the menu using the WordPress Max Mega Menu widget or shortcode.', 'megamenu' );
								echo '</p>';
							}
							...
							'general'        => array(
								...
								'settings' => array(
									'enabled'       => array(
										...
										'description' => __( 'Enable WordPress Max Mega Menu for this menu location?', 'megamenu' ),
										'settings'    => array(
											array(
							...
							'advanced'       => array(
								...
								'settings' => array(
									...
									'active_instance'  => array(
										...
										'description' => __( 'Some themes will output this menu location multiple times on the same page. For example, it may be output once for the main menu, then again for the mobile menu. This setting can be used to make sure WordPress Max Mega Menu is only applied to one of those instances.', 'megamenu' ),
										'settings'    => array(
											array(
		...
		public function print_location_widget_option( $location, $value ) {
			?>
			<textarea readonly="readonly"><?php _e( "Add the 'WordPress Max Mega Menu' widget to a widget area.", 'megamenu' ); ?></textarea>
			<?php
		}
