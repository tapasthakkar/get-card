						...
						<td class='mega-value'>
							...
							<div class='mega-description'>
								...
								<div class='disabled' style='display: <?php echo 'disabled' === $css ? 'block' : 'none'; ?>'>
									...
									<div class='fail'><?php esc_html_e( 'Selecting this option will effectively disable the theme editor and many of the features available in WordPress Max Mega Menu and WordPress Max Mega Menu Pro. Only enable this option if you fully understand the consequences.', 'megamenu' ); ?>
								</div>
							</div>
						</td>
					</tr>
