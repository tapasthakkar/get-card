...
if ( ! class_exists( 'Mega_Menu_Tools' ) ) :
	...
	class Mega_Menu_Tools {
		...
		/**
		 * Deletes all WordPress Max Mega Menu data from the database
		 *
		 * @since 1.5
		 */
			...
			<table>
				...
				<tr>
					<td class='mega-name'>
						...
						<div class='mega-description'><?php _e( 'Delete all saved WordPress Max Mega Menu plugin data from the database. Use with caution!', 'megamenu' ); ?></div>
					</td>
					<td class='mega-value'>
						<form action="<?php echo admin_url( 'admin-post.php' ); ?>" method="post">
