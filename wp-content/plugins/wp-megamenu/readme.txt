...
WordPress Max Mega Menu is developed with a focus on code quality, performance and usability.
...
1. Search for "WordPress Max Mega Menu"
1. Click "Install"
...
* New: Off canvas mobile options under Appearance > Menus > WordPress Max Mega Menu Settings > Effect (Mobile). Remember to clear any CSS caching or minification plugins if you have problems activating this functionality.
...
We hope you enjoy WordPress Max Mega Menu and the new updates. If you have a spare moment please leave us a quick [review](https://wordpress.org/support/plugin/megamenu/reviews/#new-post). Thanks!
...
* Improvement: Add notice to Navigation Menu widget to let users know that the WordPress Max Mega Menu widget should be used, if the intention is to display a mega menu
...
* Change: Remove Appearance > WordPress Max Mega Menu redirect
...
* New Feature: WordPress Max Mega Menu widget to display a menu location within a sidebar
