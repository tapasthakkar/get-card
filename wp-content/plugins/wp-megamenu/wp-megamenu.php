<?php
/**
 * Plugin Name: WordPress Max Mega Menu
 ...
 *
 * WordPress Max Mega Menu is free software: you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 2 of the License, or
 * any later version.
 *
 * WordPress Max Mega Menu is distributed in the hope that it will be useful,
...
if ( ! class_exists( 'Mega_Menu' ) ) :
	...
	final class Mega_Menu {
		...
		/**
		 * Register menu locations created within WordPress Max Mega Menu.
		 *
		 * @since 1.8
		 */
...
.		 * @param  array $pages Pages to load tinymce scripts on
		...
		public function register_sidebar() {
			...
			register_sidebar(
				array(
					'id'          => 'mega-menu',
					'name'        => __( 'WordPress Max Mega Menu Widgets', 'megamenu' ),
					'description' => __( 'This is where WordPress Max Mega Menu stores widgets that you have added to sub menus using the mega menu builder. You can edit existing widgets here, but new widgets must be added through the Mega Menu interface (under Appearance > Menus).', 'megamenu' ),
				)
			);
		}
		...
		public function admin_notices() {
			...
			if ( ! $this->is_compatible_wordpress_version() ) :
				...
				?>
			<div class="error">
				<p><?php esc_html_e( 'WordPress Max Mega Menu is not compatible with your version of WordPress. Please upgrade WordPress to the latest version or disable WordPress Max Mega Menu.', 'megamenu' ); ?></p>
			</div>
				<?php
				...
				<p>
					<?php
						printf(
							...
							esc_html__( 'WordPress Max Mega Menu has been updated. Please %s to ensure maximum compatibility with the latest version.', 'megamenu' ),
		...
		/**
		 * Add a note to the Navigation Widget to explain that WordPress Max Mega Menu will not work with it.
		 *
		 * @since 2.5.1
		 */
			...
			if ( 'nav_menu' === $widget->id_base ) {
				?>
					<p style="font-size: 11px; font-style: italic;">
						<?php esc_html_e( "If you are trying to display WordPress Max Mega Menu here, use the 'WordPress Max Mega Menu' widget instead.", 'megamenu' ); ?>
...
if ( ! function_exists( 'max_mega_menu_is_enabled' ) ) {
	/**
	 * Determines if WordPress Max Mega Menu has been enabled for a given menu location.
	 *
	 * Usage:
	 *
	 * WordPress Max Mega Menu is enabled:
	 * function_exists( 'max_mega_menu_is_enabled' )
	 *
	 * WordPress Max Mega Menu has been enabled for a theme location:
